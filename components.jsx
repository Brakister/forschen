...
function Contact(){
  ...
  const onSubmit = (e)=>{
    e.preventDefault();
    const f = e.target;
    const subject = encodeURIComponent('Contato via site — FORSCHEN');
    ...
    <section className="contact scroll-block" id="contato">
      <div className="wrap contact-grid">
        <Reveal className="section-head">
          ...
          <p>Para mais dúvidas, entre em contato pelo formulário ao lado ou acompanhe nossas novidades no Instagram.</p>
        ...
        <Reveal delay={120}>
          <form className="contact-form" onSubmit={onSubmit}>
            <label><span>Empresa</span><input name="company" type="text" placeholder="Sua empresa"/></label>
            <label><span>E-mail</span><input name="email" type="email" required placeholder="voce@empresa.com"/></label>
            <label><span>Telefone</span><input name="phone" type="tel" placeholder="(00) 00000-0000"/></label>
            <label><span>Mensagem</span><textarea name="message" rows="5" required placeholder="Como podemos ajudar?"></textarea></label>
            <button type="submit" className="btn-primary">Enviar Mensagem →</button>
            {sent && <p className="form-note">Sua mensagem foi preparada. Envie pelo seu aplicativo de e-mail para concluirmos o contato.</p>}
          </form>
        </Reveal>
      </div>
    </section>
